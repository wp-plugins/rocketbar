(function(b){var l,q,r;b(document).ready(function(){var b=document.rocketbarCache;r=document.rocketbarBaseURL;var d=[],f=document.rocketbarCommands,c;for(c in f)if(f.hasOwnProperty(c)){var k=f[c];k.searchableIndex=d.length;k.iconHTML='<img class="wp-menu-image svg" src="'+document.rocketbarIcon+'" style="fill: white; width: 20px; height: 20px;"></div>';k.link=k.url}for(var g in b.pages)b.pages.hasOwnProperty(g)&&(c=b.pages[g],c.searchableIndex=d.length,c.iconHTML='<div class="wp-menu-image dashicons-before dashicons-admin-page"><br></div>',
...
l=function(a){var c=d.fuzzyMatches(a);c.forEach(function(a,e){var f=d.indexOf(a.text);c[e]=s(f,b);c[e].txt="";c[e].priority=a.priority;a.text.split("").forEach(function(b,f){-1!==a.matches.indexOf(f)?c[e].txt+="<strong>"+b+"</strong>":c[e].txt+=b})});return c};q=function(a){if(a.trim().length){var b=a.trim().split(" ")[0].toLowerCase();a=a.replace(b,"").trim();var c=!1,e;for(e in f)if(f.hasOwnProperty(e)){var d=f[e];c||0!==e.indexOf(b)||(d.dynamicLink=a.length&&d.param?d.url+d.start+d.param+"="+encodeURIComponent(a):
